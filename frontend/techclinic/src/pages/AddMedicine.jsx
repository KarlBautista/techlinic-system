        ...
        >
          ...
          >
            <div className="flex flex-col gap-1.5">
              <label className="text-xs font-medium text-gray-500 dark:text-[#94969C] uppercase tracking-wider">Medicine Name</label>
              <input type="text" name="name" value={medicine.name} onChange={handleChange} placeholder="Paracetamol"
                className="rounded-xl border border-gray-200 dark:border-[#1F2A37] px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-crimson-100 dark:ring-[#333741] focus:border-crimson-400 transition-all" />
            </div>
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-xs font-medium text-gray-500 dark:text-[#94969C] uppercase tracking-wider">Dosage</label>
              <input type="text" name="dosage" value={medicine.dosage} onChange={handleChange} placeholder="500mg"
                className="rounded-xl border border-gray-200 dark:border-[#1F2A37] px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-crimson-100 dark:ring-[#333741] focus:border-crimson-400 transition-all" />
            </div>

            <div className="flex flex-col gap-1.5">
              <label className="text-xs font-medium text-gray-500 dark:text-[#94969C] uppercase tracking-wider">Unit of Measure</label>
              <input type="text" name="unit" value={medicine.unit} onChange={handleChange} placeholder="mg"
                className="rounded-xl border border-gray-200 dark:border-[#1F2A37] px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-crimson-100 dark:ring-[#333741] focus:border-crimson-400 transition-all" />
            </div>

            <div className="flex flex-col gap-1.5">
              <label className="text-xs font-medium text-gray-500 dark:text-[#94969C] uppercase tracking-wider">Stock Level</label>
              <input type="number" name="stock" value={medicine.stock} onChange={handleChange} placeholder="100"
                className="rounded-xl border border-gray-200 dark:border-[#1F2A37] px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-crimson-100 dark:ring-[#333741] focus:border-crimson-400 transition-all" />
            </div>

            <div className="flex flex-col gap-1.5">
              <label className="text-xs font-medium text-gray-500 dark:text-[#94969C] uppercase tracking-wider">Batch Number</label>
              <input type="text" name="batch" value={medicine.batch} onChange={handleChange} placeholder="B1234"
                className="rounded-xl border border-gray-200 dark:border-[#1F2A37] px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-crimson-100 dark:ring-[#333741] focus:border-crimson-400 transition-all" />
            </div>

            <div className="flex flex-col gap-1.5">
              <label className="text-xs font-medium text-gray-500 dark:text-[#94969C] uppercase tracking-wider">Expiry Date</label>
