...
const glassCard = 'rounded-2xl bg-white/60 backdrop-blur-xl border border-white/40 shadow-[0_8px_32px_rgba(0,0,0,0.08)] p-5 relative overflow-hidden'
const glassCardHover = 'transition-all duration-300 hover:shadow-[0_12px_40px_rgba(0,0,0,0.12)] hover:bg-white/70'
    ...
    return (
        ...
        >
            ...
            <div className='pointer-events-none absolute inset-0 overflow-hidden -z-10'>
                <div className='absolute -top-24 -right-24 w-96 h-96 rounded-full bg-crimson-100/40 blur-3xl' />
                <div className='absolute -bottom-32 -left-32 w-md h-112 rounded-full bg-blue-100/30 blur-3xl' />
                <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 rounded-full bg-amber-50/40 blur-3xl' />
            </div>
            ...
            >
                <div className='flex items-center gap-4'>
                    <div className='w-12 h-12 rounded-xl bg-crimson-50 flex items-center justify-center ring-1 ring-crimson-100'>
                        <BarChart3 className='w-6 h-6 text-crimson-600' />
                    </div>
                    <div>
                        <h1 className='text-2xl font-bold text-gray-800 tracking-tight'>Medical Analytics</h1>
                        <p className='text-sm text-gray-400 mt-0.5'>Overview of clinic performance and reports</p>
                    </div>
                </div>
                <div className='hidden sm:flex items-center gap-2 px-4 py-2 bg-white/50 backdrop-blur-md rounded-full border border-emerald-200/60 shadow-sm'>
